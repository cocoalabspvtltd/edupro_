...
class BidsRepository implements IBidsRepository {
  ...
  @override
  Future<Either<NetworkFailure, BidInstructionsResponse>> getBidInstructionsList() async {
    try {
      Response response = await apiClient!
          .getJsonInstance()
          .get(Api.getBidInstructionsList);

      return right(BidInstructionsResponse.fromJson(response.data));
    } on DioError catch (e) {
      if (e.response != null) {
        if (e.response!.statusCode == 401) {
          return left(
