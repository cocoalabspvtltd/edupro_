...
import 'package:pgs_edupro/infrastructure/remote_data/insiistution_adding_responses/institution_course_response.dart';
...
class InstitutionCourseBloc extends Bloc<InstitutionCourseEvent, InstitutionCourseState> {
  ...
  InstitutionCourseBloc(this.addCoursesInstitution) : super(InstitutionCourseState.initial()) {
