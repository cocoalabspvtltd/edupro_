...
import 'package:pgs_edupro/presentation/ui/school/school_home/school_home_screen.dart';


class SchoolDrawerWidget extends StatelessWidget {
  final BuildContext context;
  final GlobalKey<ScaffoldState> scaffoldKey;
  const SchoolDrawerWidget(
                ...
                child: ListView(
                  ...
                  children: [
                    ...
                    ExpansionTile(
                      ...
                      EdgeInsets.only(left: 60), //children padding
                      children: [
                        _drawerMenuItem1('Department List', () {

                        }),
                        _drawerMenuItem1('Add Departments', () {
                        }),
                        //more child menu
                      ],
                    ),
