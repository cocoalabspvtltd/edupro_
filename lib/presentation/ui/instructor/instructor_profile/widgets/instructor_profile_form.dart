...
import 'package:pgs_edupro/presentation/ui/instructor/instructor_profile/change_pw_instructor_screen.dart';


class InstructorProfileForm extends StatelessWidget {
  const InstructorProfileForm({super.key});
          ...
          child: ListView(
            ...
            children: <Widget>[
              ...
              DateTimeFormField(
                ...
                decoration: InputDecoration(
                  ...
                  prefixIcon: Image.asset(state.enableEdit
                      ...
                      : 'assets/icons/profile_icons/calender.png',color: primaryColor,),
                  prefixIconConstraints: const BoxConstraints(
                    maxHeight: 30,
                    minHeight: 30,
                    maxWidth: 50,
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                    onPressed: () {
                      Get.to(() => InstructorChangePasswordScreen());
                    },
                    child: const Text("Change Password")),
              ),
              if (state.isSubmitting) ...[
