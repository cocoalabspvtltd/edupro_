...
class AddJobsForm extends StatefulWidget {
  const AddJobsForm({Key? key}) : super(key: key);
...
class _AddJobsFormState extends State<AddJobsForm> {
  ...
  Widget build(BuildContext context) {
      ...
      child: ListView(
        ...
        children: <Widget>[
          ...
          _textForm(
              ...
              hint: "Skill"),
          const SizedBox(height: 10),
          Text("Company logo",style: TextStyle(color: Colors.black,fontSize: 16),),
          const SizedBox(height: 10),
          _image != null
    ...
    //   BlocConsumer<InstitutionClassBloc, InstitutionClassState>(
